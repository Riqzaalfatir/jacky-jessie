...
// VERSI SUDAH DENGAN USE IS MOBILE
"use client"
...
/>
      ...
      {isMobile ? (
        ...
        <motion.div {...topAnim(start, 0)} className="absolute top-0 left-0 w-[416px]">
      ...
      {isMobile ? (
        ...
        <motion.div {...topAnim(start, 0)} className="absolute top-0 right-0 w-[416px]">
          <Image src="/images/Hero/dekstop/Pohon-KananAtas.png" alt="Pohon Kanan Atas" width={958} height={211} className="w-full" />
        </motion.div>
      )}
      ...
      <div className="relative z-10 w-full flex flex-col items-center justify-center leading-none">
        <motion.div initial={false} animate={{ opacity: start ? 1 : 0 }} transition={{ duration: 1, ease: "easeIn", delay: 0.2 }} className="mx-auto">
          <Image src="/images/Hero/Logo-J.svg" alt="Logo J" width={99} height={99} className={`${isMobile ? "w-[65px]" : "w-[99px]"}`} />
        </motion.div>
        <motion.div initial={false} animate={{ opacity: start ? 1 : 0 }} transition={{ duration: 1, ease: "easeIn", delay: 0.5 }}>
          <p className={`uppercase font-creators ${isMobile ? "text-[14px] mt-[38px]" : "text-[20px] mt-[50px]"} text-[#713324] tracking-widest`}>THE WEDDING OF</p>
        </motion.div>
      ...
      {start && (
        <>
          ...
          {isMobile ? (
            ...
            <motion.div {...bottomAnim} className="absolute bottom-0 left-0 w-[21vw] z-[3]">
              <Image src="/images/Hero/dekstop/Pohon-KiriBawah.png" alt="Pohon Golden Kiri Bawah" width={460} height={282} className="w-full" />
            </motion.div>
          )}

          {/* Daun Pandan */}
          <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.1 }} className={`absolute bottom-0 ${isMobile ? "-left-[10vw] w-[34.7vw] z-[4]" : "-left-[3vw] w-[11.98vw] z-[5]"}`}>
            <Image src="/images/Hero/svg/Daun-Pandan.svg" alt="Daun Pandan" width={80} height={81} className="w-full" />
          </motion.div>

          {/* Pohon Buah Merah Kiri */}
          <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.15 }} className={`absolute bottom-0 left-0 ${isMobile ? "w-[36vw] z-[1]" : "w-[13vw] z-[4]"}`}>
          ...
          <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.25 }} className={`absolute bottom-0 ${isMobile ? "left-[13vw] w-[19vw] z-[2]" : "left-[10vw] w-[7.7vw] z-[4]"}`}>
            <Image src="/images/Hero/MawarKuning..png" alt="Bunga Mawar Kuning" width={580} height={80} className="w-full" />
          </motion.div>

          {/* Daun Pandan tengah kiri */}
          <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.3 }} className={`absolute bottom-0 z-[2] ${isMobile ? "left-[22.3vw] w-[18vw]" : "left-[13vw] w-[9.2vw]"}`}>
            <Image src="/images/Hero/Daun-Pandan.png" alt="Daun Pandan" width={546} height={80} className="w-full" />
          </motion.div>

          {/* Pohon Akar */}
          <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.35 }} className={`absolute bottom-0 z-[1] ${isMobile ? "left-[30.5vw] w-[27.8vw]" : "left-[17vw] w-[11vw]"}`}>
            <Image src="/images/Hero/Pohon-Akar.png" alt="Pohon Akar" width={520} height={80} className="w-full" />
          </motion.div>

          {/* Pohon Bunga Kecil */}
          <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.4 }} className={`absolute bottom-0 z-[2] ${isMobile ? "left-[44vw] w-[24vw]" : "left-[21.7vw] w-[10.2vw]"}`}>
            <Image src="/images/Hero/Pohon-BungaKecil.png" alt="Pohon Bunga Kecil" width={500} height={80} className="w-full" />
          </motion.div>

          {/* Pohon Akar 2 */}
          <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.45 }} className={`absolute bottom-0 z-[1] ${isMobile ? "left-[53vw] w-[17.8vw]" : "left-[26vw] w-[10vw]"}`}>
            <Image src="/images/Hero/Pohon-Akar.png" alt="Pohon Akar" width={520} height={80} className="w-full" />
          </motion.div>

          {/* Daun Pandan kanan tengah */}
          <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.5 }} className={`absolute bottom-0 z-[2] ${isMobile ? "left-[58.5vw] w-[26.6vw]" : "left-[31vw] w-[9vw]"}`}>
            <Image src="/images/Hero/Daun-Pandan.png" alt="Daun Pandan" width={500} height={80} className="w-full" />
          </motion.div>

          {/* Bunga Mawar Putih kanan */}
          <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.55 }} className={`absolute bottom-0 z-[3] ${isMobile ? "left-[73.5vw] w-[16vw]" : "left-[37.2vw] w-[5.2vw]"}`}>
          ...
          <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.6 }} className={`absolute bottom-0 ${isMobile ? "left-[82vw] w-[18vw] z-[3]" : "left-[38.5vw] w-[7vw] z-[2]"}`}>
            <Image src="/images/Hero/MawarKuning..png" alt="Bunga Mawar Kuning" width={500} height={80} className="w-full" />
          </motion.div>

          {/* Pohon Bunga Merah Kanan */}
          <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.6 }} className={`absolute bottom-0 z-[1] ${isMobile ? "right-[1vw] w-[29vw]" : "left-[41vw] w-[14vw]"}`}>
            <Image src="/images/Hero/dekstop/Bunga-Merah.webp" alt="Bunga Bunga Merah" width={650} height={80} className="w-full" />
          </motion.div>

          {/* Daun Pandan */}
          <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.1 }} className={`absolute bottom-0 ${isMobile ? "-left-[10vw] w-[34.7vw] z-[4]" : "left-[41vw] w-[10vw] z-[1]"}`}>
            <Image src="/images/Hero/svg/Daun-Pandan.svg" alt="Daun Pandan" width={80} height={81} className="w-full" />
          </motion.div>
          ...
          {!isMobile && (
            <>
              ...
              <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.15 }} className="absolute bottom-0 left-[10vw] w-[13vw] z-[1]">
              ...
              <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.15 }} className="absolute bottom-0 left-[25vw] w-[15vw] z-[1]">
                <Image src="/images/Hero/dekstop/Bunga-Merah.webp" alt="Pohon Buah Merah" width={550} height={120} className="w-full scale-x-[-1]" />
              </motion.div>

              {/* Mawar Putih tengah */}
              <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.55 }} className="absolute bottom-0 z-[3] left-[48vw] w-[7.2vw]">
                <Image src="/images/Hero/dekstop/Mawar-Putih.svg" alt="Bunga Mawar Putih" width={500} height={80} className="w-full" />
              </motion.div>

              {/* Mawar Kuning tengah */}
              <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.6 }} className="absolute bottom-0 left-[52vw] w-[7vw] z-[2]">
                <Image src="/images/Hero/MawarKuning..png" alt="Bunga Mawar Kuning" width={500} height={80} className="w-full" />
              </motion.div>

              {/* Pohon Bunga Merah tengah */}
              <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.6 }} className="absolute bottom-0 left-[55.5vw] w-[12vw] z-[1]">
                <Image src="/images/Hero/dekstop/Bunga-Merah.webp" alt="Bunga Bunga Merah" width={650} height={80} className="w-full" />
              </motion.div>

              {/* Daun Pandan tengah */}
              <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.1 }} className="absolute bottom-0 left-[55vw] w-[10vw] z-[2]">
                <Image src="/images/Hero/svg/Daun-Pandan.svg" alt="Daun Pandan" width={80} height={81} className="w-full" />
              </motion.div>

              {/* Pohon Akar kanan */}
              <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.35 }} className="absolute bottom-0 left-[60vw] w-[11vw] z-[1]">
                <Image src="/images/Hero/Pohon-Akar.png" alt="Pohon Akar" width={520} height={80} className="w-full" />
              </motion.div>

              {/* Pohon Bunga Kecil kanan */}
              <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.4 }} className="absolute bottom-0 left-[64vw] w-[9vw] z-[2]">
                <Image src="/images/Hero/Pohon-BungaKecil.png" alt="Pohon Bunga Kecil" width={500} height={80} className="w-full" />
              </motion.div>

              {/* Pohon Akar kanan 2 */}
              <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.35 }} className="absolute bottom-0 left-[67vw] w-[10vw] z-[1]">
                <Image src="/images/Hero/Pohon-Akar.png" alt="Pohon Akar" width={520} height={80} className="w-full" />
              </motion.div>

              {/* Daun Pandan kanan */}
              <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.1 }} className="absolute bottom-0 left-[70.5vw] w-[12vw] z-[5]">
                <Image src="/images/Hero/svg/Daun-Pandan.svg" alt="Daun Pandan" width={80} height={81} className="w-full" />
              </motion.div>

              {/* Pohon Buah Merah flip kanan */}
              <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.15 }} className="absolute bottom-0 left-[66.5vw] w-[15.5vw] z-[4]">
                <Image src="/images/Hero/dekstop/Bunga-Merah.webp" alt="Pohon Buah Merah" width={550} height={120} className="w-full scale-x-[-1]" />
              </motion.div>

              {/* Mawar Putih kanan */}
              <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.2 }} className="absolute bottom-0 right-[16.5vw] w-[9vw] z-[7]">
                <Image src="/images/Hero/dekstop/Mawar-Putih.svg" alt="Bunga Mawar Putih" width={770} height={70} className="w-full" />
              </motion.div>

              {/* Mawar Kuning kanan */}
              <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.25 }} className="absolute bottom-0 right-[11.5vw] w-[11vw] z-[6]">
                <Image src="/images/Hero/MawarKuning..png" alt="Bunga Mawar Kuning" width={580} height={80} className="w-full" />
              </motion.div>

              {/* Daun Pandan paling kanan */}
              <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.3 }} className="absolute bottom-0 right-[6vw] w-[11vw] z-[2]">
                <Image src="/images/Hero/Daun-Pandan.png" alt="Daun Pandan" width={546} height={80} className="w-full" />
              </motion.div>

              {/* Mawar Putih ujung kanan */}
              <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.2 }} className="absolute bottom-0 -right-[2vw] w-[10vw] z-[7]">
                <Image src="/images/Hero/dekstop/Mawar-Putih.svg" alt="Bunga Mawar Putih" width={770} height={70} className="w-full" />
              </motion.div>

              {/* Pohon Buah Merah ujung kanan flip */}
              <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.15 }} className="absolute bottom-0 right-[0vw] w-[15.5vw] z-[1]">
                <Image src="/images/Hero/dekstop/Bunga-Merah.webp" alt="Pohon Buah Merah" width={550} height={120} className="w-full scale-x-[-1]" />
              </motion.div>

              {/* Golden Kanan Desktop */}
              <motion.div {...bottomAnim} transition={{ duration: 1.2, ease: "easeIn", delay: 0.1 }} className="absolute z-[1] bottom-[6vw] right-[0vw] w-[15vw]">
              ...
              <motion.div {...bottomAnim} transition={{ duration: 1, ease: "easeIn", delay: 0 }} className="absolute bottom-0 left-[11.5vw] w-[30vw] z-[0]">
              ...
              <motion.div {...bottomAnim} transition={{ duration: 1, ease: "easeIn", delay: 0.2 }} className="absolute bottom-0 w-[26vw] right-[6vw] z-[0]">
                <Image src="/images/Hero/dekstop/Dedaunan-Belakang.webp" alt="Dedaunan Belakang" width={650} height={80} className="w-full" />
              </motion.div>
              <motion.div {...bottomAnim} transition={{ duration: 1, ease: "easeIn", delay: 0.2 }} className="absolute bottom-0 w-[21vw] right-[18vw] z-[0]">
                <Image src="/images/Hero/dekstop/Dedaunan-Belakang.webp" alt="Dedaunan Belakang" width={650} height={80} className="w-full" />
              </motion.div>
              <motion.div {...bottomAnim} transition={{ duration: 1, ease: "easeIn", delay: 0.2 }} className="absolute bottom-0 w-[22vw] right-[26vw] z-[0]">
                <Image src="/images/Hero/dekstop/Dedaunan-Belakang.webp" alt="Dedaunan Belakang" width={650} height={80} className="w-full" />
              </motion.div>
              <motion.div {...bottomAnim} transition={{ duration: 1, ease: "easeIn", delay: 0.2 }} className="absolute bottom-0 w-[34vw] right-[30vw] z-[0]">
                <Image src="/images/Hero/dekstop/Dedaunan-Belakang.webp" alt="Dedaunan Belakang" width={650} height={80} className="w-full" />
              </motion.div>

              {/* Kupu Kupu Desktop */}
              <Image src="/images/Hero/KupuKupu-1.gif" alt="Kupu Kupu 1" width={87} height={87} className="absolute bottom-[17vw] left-[17vw] w-[5vw] z-[5]" />
              <Image src="/images/Hero/KupuKupu-2.gif" alt="Kupu Kupu 2" width={87} height={87} className="absolute bottom-[7.8vw] left-[73.4vw] w-[3.5vw] z-[5]" />
              <Image src="/images/Hero/KupuKupu-3.gif" alt="Kupu Kupu 3" width={87} height={87} className="absolute bottom-[8vw] left-[40vw] w-[3.5vw] z-[5] scale-x-[-1]" />
              <Image src="/images/Hero/KupuKupu-3.gif" alt="Kupu Kupu 3" width={87} height={87} className="absolute top-[40%] right-[7vw] w-[4vw] z-[5]" />
            </>
          )}
          ...
          <motion.div {...bottomAnim} transition={{ duration: 1, ease: "easeIn", delay: 0 }} className={`absolute bottom-0 z-[0] ${isMobile ? "left-0 w-[55vw]" : "-left-[3.1vw] w-[31.5vw]"}`}>
          ...
          <motion.div {...bottomAnim} transition={{ duration: 1, ease: "easeIn", delay: 0.1 }} className={`absolute bottom-0 z-[0] ${isMobile ? "right-[22vw] w-[43vw]" : "left-[27.59vw] w-[20.14vw]"}`}>
          ...
          <motion.div {...bottomAnim} transition={{ duration: 1, ease: "easeIn", delay: 0.2 }} className={`absolute bottom-0 right-0 z-[0] ${isMobile ? "w-[55vw]" : "w-[25vw] -right-[4.5vw]"}`}>
