...
const Hero = () => {
  return (
    ...
    <section
      id="hero"
      className="relative w-full pt-[42.8vw] pb-[70vw] bg-[#FEF8EF] overflow-x-hidden"
    >
      {/* Background Image */}
      <Image
      ...
      {/* ASET BAGIAN ATAS */}
      <Image
        src="/images/Hero/Pohon-KiriAtas.svg"
        alt="Pohon Kiri Atas"
        width={258}
        height={211}
...
// const Hero = () => {
//   return (
//     <section id="hero" className="relative w-full pt-[167px] pb-[273px]">
//       {/* Background Image */}
//       <Image
//         src="/images/Hero/Bg-Hero.webp"
//         alt="Hero Background"
...
//         width={70}
//         height={70}
//         className="absolute bottom-0 left-11 z-[2]"
//       />
...
//         width={80}
//         height={80}
//         className="absolute bottom-0 left-14 z-[0]"
//       />
...
//         width={46}
//         height={80}
//         className="absolute bottom-0 left-[125px] z-[0]"
//       />
...
//         width={120}
//         height={80}
//         className="absolute bottom-0 left-[140px] z-[0]"
//       />
...
//         width={100}
//         height={80}
//         className="absolute bottom-0 left-[200px] z-[0]"
//       />
...
//         width={100}
//         height={80}
//         className="absolute bottom-0 left-[240px] z-[0]"
//       />
...
//           className="mx-auto"
//         />
//         <p className="uppercase font-creators text-[14px] text-[#713324] tracking-widest mt-[42px]">
//           THE WEDDING OF
//         </p>
