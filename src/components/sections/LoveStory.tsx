  ...
  return (
    ...
    >
      ...
      <Image
        ...
        width={160}
        height={282}
        className="absolute bottom-0 right-0 w-[55vw] z-[1]"
      />
      ...
      <div className="relative z-10 w-full flex flex-col items-center justify-center leading-none">
        <h2 className="font-cylburn text-[42px] text-[#713324]">Love Story</h2>
      </div>
      ...
      <div className="flex flex-col items-center justify-center text-center mt-[51px]">
        ...
        <h3 className="font-creators text-[12px] text-[#713324] mt-2">
