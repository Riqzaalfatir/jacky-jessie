...
<div className="relative z-10 flex flex-col items-center justify-center leading-none text-center">
  ...
  <motion.p
    ...
    className="font-creators text-[12px] text-[#713324] tracking-wide leading-[20px]"
  >
  ...
  <motion.div
    ...
    className="mt-[26px]"
  >
    <Image src="/images/Tentang/Pengantin-Laki.png" alt="Pengantin Laki-Laki" width={200} height={261} />
  </motion.div>
  ...
  <motion.h1
    ...
    transition={{ duration: 1.8, ease: "easeOut" }}
    style={{ willChange: "transform" }}
    className="font-cylburn text-[40px] text-[#713324] mt-[49px]"
  >
    Jacky Steven Rusli
  </motion.h1>
  ...
  <motion.div
    ...
    transition={{ duration: 1.8, ease: "easeOut" }}
    style={{ willChange: "transform" }}
    className="flex flex-col items-center justify-center mt-[31px]"
  >
    <p className="font-creators text-[12px] text-[#713324] tracking-wide">The Son of</p>
    <p className="font-creators text-[12px] text-[#713324] mt-3 tracking-wide">Mr. AGUS RUSLI and</p>
    <p className="font-creators text-[12px] text-[#713324] mt-1.5 tracking-wide">Mrs. ONG KIE LIM (TRIDEWI)</p>
  </motion.div>
  ...
  <motion.div
    ...
    className="mt-[45px]"
  >
    <Image src="/images/Tentang/Pengantin-Perempuan.png" alt="Pengantin Perempuan" width={200} height={261} />
  </motion.div>
  ...
  <motion.h1
    ...
    transition={{ duration: 1.8, ease: "easeOut" }}
    style={{ willChange: "transform" }}
    className="font-cylburn text-[40px] text-[#713324] mt-[43px]"
  >
  ...
  <motion.div
    ...
    transition={{ duration: 1.8, ease: "easeOut" }}
    style={{ willChange: "transform" }}
    className="flex flex-col items-center justify-center mt-[24px] tracking-wide"
  >
    <p className="font-creators text-[12px] text-[#713324]">The Daughter of</p>
    <p className="font-creators text-[12px] text-[#713324] mt-4">Mr. Wibowo Santoso and</p>
    <p className="font-creators text-[12px] text-[#713324] mt-2">Mrs. Imelda Sien</p>
  </motion.div>
  ...
  <motion.p
    ...
    transition={{ duration: 1.8, ease: "easeOut" }}
    style={{ willChange: "transform" }}
    className="font-creators text-[12px] text-[#713324] mt-[46px] pb-[171px] tracking-wide leading-[20px]"
  >
